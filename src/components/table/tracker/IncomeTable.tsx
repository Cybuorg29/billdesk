...
const IncomeTable = (props: Props) => {
  ...
  return (
    <div className='border  rounded-xl shadow-xl relative'>
      ...
      <div className='h-8 bg-black hover:h-10 duration-150 absolute bottom-0 z-40 w-full text-end  text-white  text-sm grid justify-items-end items-center pr-10 rounded-b-xl cursor-pointer ' onClick={() => navigate('/view/all/income')}  >
