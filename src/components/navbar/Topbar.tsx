...
const Topbar = ({ }: props) => {
  ...
  return (
    <>
      <div className=' text-center text-black border bg-transparent shadow-md lg:w-full sm:w-full grid grid-cols-4  duration-300  rounded-xl  bg-white    ' >
        ...
        <div className=' lg:p-5  font-head  grid   gap-3 justify-items-center col-span-2   items-center lg:pl-8 '  > <div className='text-center lg:text-2xl'>{name}</div> </div>
