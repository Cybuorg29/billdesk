...
const ViewDebitNoteDialog = ({ open, close, id }: Props) => {
    ...
    useEffect(() => {
        if (DebitNote.isLoaded) {
            const find = DebitNote.notes.find((value) => value._id === id);
        ...
        <Dialog open={open} fullScreen className='p-5' >
            <div className='w-full h-full '>
                ...
                <div className='flex h-[8%] place-content-between p-3  border-b-2'>
                    <div className='text-xl'>View Debit Note</div>
                    ...
                    >
                        <div className='h-fit w-full p-10 ' ref={targetRef}>
                            ...
                            <div className='w-full  min-h-[15rem]  border-2  border-black' >
                                <div className='p-3 border-b-2 border-black flex place-content-center text-lg'>Debit Note</div>
...
export default ViewDebitNoteDialog