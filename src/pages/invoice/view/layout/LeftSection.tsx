  ...
  return (
    <div className='p-4 h-full w-full  text-sm font-bold ' ref={targetRef}   >
      ...
      <div className='w-full h-full ' >
        ...
        <div className='h-[15%] border-2 border-black'>
        ...
        <div className='h-[16%] border-black border-b grid grid-cols-2 border-l-2    border-r-2   '>
          <div className='border-r-2    border-black  '>
            <div className='border-b-2 border-black pl-2 text-sm font-semibold '>Billed To</div>
            <BillingDetails array={invoice.billed_To} />
          </div>
          <div >
            <div className='border-b-2   border-black pl-2 text-sm font-semibold '>Shipped  To</div>
        ...
        <div className='h-[8%] text-xs border-l-2 border-r-2 border-black  border-t-2 grid'>
          <div className='border-b pl-2 border-black'>Bank Details :- {invoice.bank.name}</div>
