...
type Props = {value:string,onchange:any}
...
const SearchBar = ({ value,onchange}: Props) => {
  ...
  <div className="relative mb-4 flex w-full flex-wrap items-stretch">
    ...
    <button
      ...
      className="relative z-[2] flex items-center rounded-r bg-blue-500 px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-blue-700-700 hover:shadow-lg focus:bg-blue-700-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-700-800 active:shadow-lg"
      type="button"
      id="button-addon1"
      data-te-ripple-init
