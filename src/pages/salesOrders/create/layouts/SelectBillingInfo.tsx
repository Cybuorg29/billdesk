        ...
        <>
            <div className='w-full h-full grid grid-cols-2 gap-3 p-3'>
                <div className='h-full'>
                    <SelectINput array={[...connections.client, ...connections.supplier].filter((v, i, a) => a.indexOf(v) === i)} name='Billed To' set={(value: any) => { console.log(value); set(value, 'to'); }} value={value[0]} key={keys.billedToInput} />
                </div>
                <div className='h-full'>
